package com.andrejeu.testtaskossystem.controllers;

import com.andrejeu.testtaskossystem.model.Category;
import com.andrejeu.testtaskossystem.model.Picture;
import com.andrejeu.testtaskossystem.model.PictureDto;
import com.andrejeu.testtaskossystem.services.PictureService;
...
public class PictureController {
     ...
     * {@link com.andrejeu.testtaskossystem.services.PictureService#getPictureById(Long)}
     *
     * @param pictureId the Id of a picture which is searched
     * @return {@link com.andrejeu.testtaskossystem.model.PictureDto} object instance to client
     * */
    @RequestMapping(
     ...
     *  3) Title;
     *  4) Description;
     * Method converts image data into bytes, puts it in {@link com.andrejeu.testtaskossystem.model.PictureDto}
     * and delegates persistence further to
     * {@link com.andrejeu.testtaskossystem.services.PictureService#postPicture(PictureDto)}
     *
     ...
     * Method converts image data into bytes, puts it in {@link com.andrejeu.testtaskossystem.model.PictureDto}
     * and delegates persistence further to
     * {@link com.andrejeu.testtaskossystem.services.PictureService#editPicture(Picture)}
     *
     * @param uploadedFile expected image data
     * @param category category of a picture
     * @param title title of a picture
     ...
     * {@link com.andrejeu.testtaskossystem.services.PictureService#removePicture(Long)}
     *
     ...
     * {@link com.andrejeu.testtaskossystem.services.PictureService#getPicturesPage(int)}
     *
     ...
     * {@link com.andrejeu.testtaskossystem.services.PictureService#getPicturesPage(int, String)}
     *
     * @param pageIndex the index of a page of picture
