...
public class Picture {
    ...
    /**
     * Constructor for converting from {@link com.andrejeu.springtestproject.model.PictureDto} object instance
     * to Picture entity. Also doesn't take id value because it db staff.
     *
     * @param picture {@link com.andrejeu.springtestproject.model.PictureDto} for converting.
     * */
